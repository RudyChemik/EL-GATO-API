...
namespace ElGato_API.Interfaces
{
    public interface IDietService
    {
        ...
        Task<BasicErrorResponse> DeleteMealsFromSaved(string userId, DeleteSavedMealsVM model);
        ...
        Task<BasicErrorResponse> UpdateSavedMealIngridientWeight(string userId, UpdateSavedMealWeightVM model);
